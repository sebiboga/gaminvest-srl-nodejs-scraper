...
const baseCompany = {
  ...
  status: "activ",
  location: ["Oradea"],
  website: ["https://www.gaminvest.ro"],
  career: ["https://www.gaminvest.ro/cariere.html"],
  lastScraped: "2026-06-17"
};

const baseJob = {
  url: "https://www.gaminvest.ro/en/vacancy/123_en",
...
describe("generateJobsMarkdown", () => {
  describe("company section", () => {
    it("includes company name as h1", () => {
      ...
      expect(md).toContain("# GAMINVEST SRL");
    });

    it("includes CIF", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("21913994");
    });

    it("includes brand", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("GAMINVEST");
    });
    ...
    it("includes website as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("[https://www.gaminvest.ro](https://www.gaminvest.ro)");
    });

    it("includes career page as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, []);
      expect(md).toContain("[https://www.gaminvest.ro/cariere.html](https://www.gaminvest.ro/cariere.html)");
    });
    ...
    it("omits optional fields when not present", () => {
      const minimal = { id: "21913994", company: "GAMINVEST SRL" };
  ...
  describe("jobs section", () => {
    ...
    it("includes job URL as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, [baseJob]);
      expect(md).toContain("[https://www.gaminvest.ro/en/vacancy/123_en]");
    });
    ...
    it("renders multiple jobs", () => {
      const job2 = { ...baseJob, title: "DevOps Engineer", url: "https://www.gaminvest.ro/en/vacancy/456_en" };
    ...
    it("handles job with no optional fields", () => {
      const minimal = { url: "https://www.gaminvest.ro/en/vacancy/999_en", title: "QA Engineer" };
